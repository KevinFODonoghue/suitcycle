...
function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(
    errorParam === "BANNED" ? "Your account has been suspended." : null
  );
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
          <h1 className="text-2xl font-bold text-[#1A1A2E] mb-1 text-center">Welcome back</h1>
          <p className="text-sm text-[#64748B] text-center mb-7">Sign in to your SuitCycle account</p>
          ...
          <p className="text-center text-sm text-[#64748B] mt-6">
            ...
            <Link href="/register" className="text-[#00B4FF] font-semibold hover:underline">
              Sign up
            </Link>
          </p>
        </div>
